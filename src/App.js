    ...
    <CartProvider>
      <BrowserRouter>
        <Routes>
          ...
          {/* 404 fallback */}
          <Route path="*" element={<PublicLayout><div style={{ textAlign:'center', padding:'80px 24px', color:'var(--muted)' }}><div style={{ fontSize:64 }}>🔍</div><h2 style={{ fontFamily:'Orbitron,monospace', marginTop:16 }}>Page Not Found</h2></div></PublicLayout>} />
        </Routes>
      </BrowserRouter>
    </CartProvider>
  );
